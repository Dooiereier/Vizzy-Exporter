namespace Assets.Scripts
{
    ...
    {
        private const string ModFileName = "Vizzy Exporter.sr2-mod";
        private const string ModInfoFileName = "Vizzy Exporter.sr2-mod-info";
        private const int CopyRetryCount = 8;
        private const int CopyRetryDelayMs = 300;

        [MenuItem("Tools/Vizzy Exporter/Deploy Built Mod To Juno")]
        private static void DeployBuiltMod()
        {
            ...
            try
            {
                ...
                Debug.Log($"Vizzy Exporter deployed to {modsDirectory}");
                EditorUtility.DisplayDialog("Vizzy Exporter", "Deployed the mod into Juno's mods folder.", "OK");
            }
            catch (IOException ex)
            {
                Debug.LogError($"Vizzy Exporter deploy failed: {ex}");
                EditorUtility.DisplayDialog(
                    "Vizzy Exporter",
        ...
        [MenuItem("Tools/Vizzy Exporter/Open Juno Mods Folder")]
